...
read_chunk("./reports/social-participation/review-social-participation.R") 
```
...
<!-- Basic table view.   -->
```{r basic-table, echo=TRUE, results='show', message=FALSE,eval=F}
```

<!-- Basic graph view.   -->
```{r basic-graph, echo=TRUE, results='show', message=FALSE, eval=F}
```

#Attrition
```{r attrition-pattern, echo=FALSE, results='show', message=FALSE}
```
#Variables
The following variables have been identied as relevant to capturing the construct "Socail participation" 
```{r define-utility-functions, echo=FALSE, results='show', message=FALSE}
```

```{r print-variables, echo=FALSE, results='asis', message=FALSE}
```
